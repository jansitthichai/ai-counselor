...
const commonQuestions: Record<string, string> = {
  ...
  // คำถามเกี่ยวกับแอป
  'แอปนี้ทำอะไรได้บ้าง': 'STRMindCare มีฟีเจอร์ดังนี้:\n1. เพื่อนคู่ใจมายด์แคร์ - พูดคุยและรับคำแนะนำ\n2. ติดตามอารมณ์ - บันทึกและดูสถิติอารมณ์\n3. เกมคลายเครียด - เกมต่างๆ เพื่อผ่อนคลาย\n4. บทความสุขภาพจิต - ข้อมูลที่เป็นประโยชน์\n\nคุณสนใจฟีเจอร์ไหนเป็นพิเศษไหมครับ?'
}
...
- ตอบให้ครบถ้วน อ่านง่าย ไม่ยาวเกินไป และจบประโยคให้สมบูรณ์ทุกหัวข้อ
- หากเริ่มหัวข้อหมายเลขแล้ว ต้องเขียนเนื้อหาของหัวข้อนั้นให้จบ ห้ามตัดค้างกลางทาง
...
คำถามของผู้ใช้: `,
  ...
  general: `คุณเป็น เพื่อนคู่ใจมายด์แคร์ (STRMindCare) ที่พูดภาษาไทย
...
export function processQuestion(question: string): ExpertResponse {
  ...
  return {
    answer: '', // filled by Gemini when no rule matches
    source: 'prompt',
    confidence: 0.7,
    category: classifyQuestion(question)
  }
